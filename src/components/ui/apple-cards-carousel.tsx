    ...
    return (
        <>
                ...
                {open && (
                    <div className="fixed inset-0 z-50 h-screen overflow-auto">
                        ...
                        <motion.div
                            ...
                            className="relative z-[60] mx-auto my-10 h-fit max-w-7xl rounded-3xl bg-white p-4 font-sans md:p-10 dark:bg-neutral-900"
                        >
                            ...
                            {/* <div className="py-10 w-full">{card.content}</div> */}
                        </motion.div>
                    </div>
                )}
            </AnimatePresence>
            <motion.button
                layoutId={layout ? `card-${card.title}` : undefined}
                onClick={handleOpen}
                className="relative z-10 flex h-80 w-56 flex-col items-start justify-start overflow-hidden rounded-[50px] bg-gray-100 md:h-[40rem] md:w-96 dark:bg-neutral-900"
            >
                ...
                <BlurImage src={card.src} alt={card.title} fill className="absolute inset-0 z-10 object-fill" />
            </motion.button>
        </>
    );
};
